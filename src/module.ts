...
export default defineNuxtModule<LtExtensionsModuleOptions>({
  ...
  async setup(options, nuxt) {
    ...
    if (resolvedOptions.i18n?.autoMerge) {
      ...
      nuxt.hook('i18n:registerModule', (register: (config: { langDir: string; locales: Array<{ code: string; file: string }> }) => void) => {
        register({
...
// Re-export types (module augmentation is auto-generated by @nuxt/module-builder)
export type { LtExtensionsModuleOptions };
